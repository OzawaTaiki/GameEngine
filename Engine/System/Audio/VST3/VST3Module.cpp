...
bool Engine::VST3Module::Load(const std::string& path)
{
...
std::vector<VST3::Hosting::ClassInfo> Engine::VST3Module::GetAudioEffectClasses() const
{
...
std::unique_ptr<Engine::VST3Plugin> Engine::VST3Module::CreatePlugin(const VST3::Hosting::ClassInfo& classInfo)
{
    if (!module_)
        return nullptr;
