...
void AnimationNodeMisc::Update()
{
    ...
    if (ImGui::Button("01_View"))
    {
        aModel_->SetAnimation("animation1", true);
    }
    if (ImGui::Button("02_View"))
    {
        aModel_->SetAnimation("animation2", true);
    }
    if (ImGui::Button("03_View"))
    {
        aModel_->SetAnimation("animation3", true);
    }
